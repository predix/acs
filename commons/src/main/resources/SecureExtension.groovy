...
class SecureExtension extends GroovyTypeCheckingExtensionSupport.TypeCheckingDSL {
    ...
    Object run() {
        ...
        onMethodSelection { expr, methodNode ->
            ...
            if ((methodNode.declaringClass.name != 'org.eclipse.acs.commons.policy.condition.AbstractHandler')
                && (methodNode.declaringClass.name != 'org.eclipse.acs.commons.policy.condition.ResourceHandler')
                && (methodNode.declaringClass.name != 'org.eclipse.acs.commons.policy.condition.SubjectHandler')
                && (methodNode.declaringClass.name != 'org.eclipse.acs.commons.policy.condition.groovy.AttributeMatcher')
