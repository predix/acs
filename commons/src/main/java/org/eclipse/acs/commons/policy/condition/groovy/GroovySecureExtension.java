...
public class GroovySecureExtension extends AbstractTypeCheckingExtension {
    ...
    public void onMethodSelection(final Expression expression, final MethodNode target) {
        ...
        if ((!"org.eclipse.acs.commons.policy.condition.AbstractHandler".equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.acs.commons.policy.condition.AbstractHandlers"
                .equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.acs.commons.policy.condition.ResourceHandler"
                .equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.acs.commons.policy.condition.SubjectHandler"
                .equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.acs.commons.policy.condition.groovy.AttributeMatcher"
