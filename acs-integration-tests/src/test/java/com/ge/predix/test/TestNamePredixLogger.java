...
public class TestNamePredixLogger implements IInvokedMethodListener {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TestNamePredixLogger.class);
