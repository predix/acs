...
public class PolicyEvaluationControllerIT extends AbstractTestNGSpringContextTests {
    ...
    private Object[] requestEvaluationWithEmptyPolicySet() {
        return new Object[] {
                createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                        this.testSubject.getSubjectIdentifier(), Collections.emptyList()),
    ...
    private Object[] requestEvaluationWithSecondOfTwoPolicySets() {
        return new Object[] {
                createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                        this.testSubject.getSubjectIdentifier(), Arrays.asList(this.notApplicableAndDenyPolicySets.get(1).getName())),
    ...
    private Object[] requestEvaluationWithFirstOfTwoPolicySets() {
        return new Object[] {
                createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                        this.testSubject.getSubjectIdentifier(), Arrays.asList(this.notApplicableAndDenyPolicySets.get(0).getName())),
    ...
    private Object[] requestEvaluationWithOnePolicySetAndPriorityList() {
        return new Object[] {
                createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                        this.testSubject.getSubjectIdentifier(), Arrays.asList(this.denyPolicySet.get(0).getName())),
    ...
    private Object[] requestEvaluationWithAllOfTwoPolicySets() {
        return new Object[] {
                createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                        ...
                        Arrays.asList(this.notApplicableAndDenyPolicySets.get(0).getName(), this.notApplicableAndDenyPolicySets.get(1).getName())),
                this.notApplicableAndDenyPolicySets, Effect.DENY };

    }

    @DataProvider(name = "policyEvalBadRequestDataProvider")
    private Object[][] policyEvalBadRequestDataProvider() throws JsonParseException, JsonMappingException, IOException {
    ...
    private Object[] requestEvaluationWithExistentAndNonExistentPolicySets() {
        return new Object[] {
                createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                        this.testSubject.getSubjectIdentifier(),
                        Arrays.asList(this.notApplicableAndDenyPolicySets.get(0).getName(), "noexistent-policy-set")),
    ...
    private Object[] requestEvaluationWithTwoPolicySetsAndNoPriorityList() {
        return new Object[] { createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                this.testSubject.getSubjectIdentifier(), Collections.emptyList()), this.notApplicableAndDenyPolicySets };
    }

    private Object[] requestEvaluationWithNonExistentPolicySet() {
        return new Object[] { createPolicyEvalRequest("GET", this.testResource.getResourceIdentifier(),
                this.testSubject.getSubjectIdentifier(), Arrays.asList(new String[] { "nonexistent-policy-set" })),
                this.denyPolicySet };
    }

    private PolicyEvaluationRequestV1 createPolicyEvalRequest(final String action, final String resourceIdentifier,
            final String subjectIdentifier, final List<String> policySetsPriority) {
