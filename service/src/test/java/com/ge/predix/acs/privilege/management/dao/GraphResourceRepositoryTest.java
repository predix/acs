...
//
//        GraphTraversal<Vertex, Vertex> traversal = this.graphTraversalSource.V().has(RESOURCE_ID_KEY,
// childResourceId);
//        assertThat(traversal.hasNext(), equalTo(true));
...
//    }
//
//    private ResourceEntity persistResourceToZoneAndAssert(final ZoneEntity zoneEntity, final String
// resourceIdentifier,
