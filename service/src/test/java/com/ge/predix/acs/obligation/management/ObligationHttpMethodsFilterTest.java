...
public final class ObligationHttpMethodsFilterTest {
    ...
    public void setup() {
        ...
        this.mockMvc = MockMvcBuilders.standaloneSetup(this.obligationController)
                .addFilters(new ObligationHttpMethodsFilter()).build();
    }
