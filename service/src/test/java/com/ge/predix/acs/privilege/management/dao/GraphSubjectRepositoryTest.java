...
public class GraphSubjectRepositoryTest {
    ...
    public void testGetByZoneAndSubjectIdentifierAndScopes() {
        ...
        SubjectEntity actualSubject = this.subjectRepository.getInheritedAttributesForScopes(TEST_ZONE_1,
        ...
        expectedSubject.setAttributes(expectedAttributes);
        expectedSubject.setAttributesAsJson(JSON_UTILS.serialize(expectedAttributes));
        actualSubject = this.subjectRepository.getInheritedAttributesForScopes(TEST_ZONE_1, subjectIdentifier,
    ...
    public void testParentAndChildSameAttribute() {
        ...
        SubjectEntity actualAgentMulder = this.subjectRepository.getInheritedAttributesForScopes(TEST_ZONE_1,
                AGENT_MULDER, null);
