...
public class GraphResourceRepositoryTest {
     ...
     */
    static <E extends ZonableEntity> E saveWithRetry(final GraphGenericRepository<E> repository, final E zonableEntity,
            final int retryCount) throws TitanException {
        try {
