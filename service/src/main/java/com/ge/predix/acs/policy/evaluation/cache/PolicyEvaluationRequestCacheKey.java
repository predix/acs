...
public class PolicyEvaluationRequestCacheKey {
    ...
    private final List<String> policySetIds;
    private final String resourceId;
    private final String subjectId;
    private final String zoneId;

    public PolicyEvaluationRequestCacheKey(final PolicyEvaluationRequestV1 request, final List<String> policySetIds,
            final String zoneId) {
    ...
    public PolicyEvaluationRequestCacheKey(final List<String> policySetIds, final String resourceId,
    ...
    public List<String> getPolicySetIds() {
    ...
    public static class Builder {
        ...
        private List<String> builderPolicySetIds = Collections.emptyList();
        ...
        public Builder policySetIds(final List<String> policySets) {
