...
@Component
public class ObligationHttpMethodsFilter extends AbstractHttpMethodsFilter {

    private static final String OBLIGATION_MANAGEMENT_URI_REGEX = "\\A/v1/obligation/[^/]+?/??\\Z";
    ...
    private static Map<String, Set<HttpMethod>> uriPatternsAndAllowedHttpMethods() {
        ...
        uriPatternsAndAllowedHttpMethods.put(OBLIGATION_MANAGEMENT_URI_REGEX,
    ...
    public ObligationHttpMethodsFilter() {
