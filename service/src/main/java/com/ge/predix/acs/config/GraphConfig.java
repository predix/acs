...
//                    .set("cache.db-cache", this.cacheEnabled).set("cache.db-cache-clean-wait", this
// .titanCacheCleanWait)
...
//        mgmt.commit();
//        // Wait for the index to become available
//        ManagementSystem.awaitRelationIndexStatus((TitanGraph) newGraph, indexName, label).status(SchemaStatus
// .ENABLED)
//                .call();
//    }
//
